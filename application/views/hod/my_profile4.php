...
<div class="col-md-12">
<form class="needs-validation mt-5" novalidate method="post" action="<?php echo base_url("Hod/update_profile");?>">
  <div class="form-row">
...
<div class="col-md-12">
<form class="needs-validation mt-5" novalidate action="<?php echo base_url("Hod/change_password");?>" method="post">
  <div class="form-row">
  <div class="col-md-4 mb-3">
