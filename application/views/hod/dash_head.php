    ...
    $this->db->select('*');
     ...
     ?>
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="<?php echo site_url(); ?>dash/calendar" class="list-group-item list-group-item-action bg-light">Calendar</a>
        ...
        <a href="<?php echo base_url('/hod/events'); ?>" class="list-group-item list-group-item-action bg-light">News</a> 
