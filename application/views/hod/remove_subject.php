...
?>
                    ...
                    <link href="<?php echo base_url('assets/bootstrap-table/bootstrap-table.min.css'); ?>"
                                        rel="stylesheet">
                    ...
                    <nav aria-label="breadcrumb mt-sm-5">
                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item active" aria-current="page">All Subjects
                                                            </li>
                                        </ol>
                    </nav>
                    ...
                    <div class="container" class="col-sm-12">
                                        ...
                                        <table id="table" data-show-export="true" data-toolbar="#toolbar"
                                                            data-search="true" data-sortable="true"
                                                            data-show-columns="true" data-toggle="table"
    ...
    ?>
                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><?php echo $subject->sub_name ?>
                                                                                                    </td>
                                                                                                    <td><?php echo $subject->sub_course ?>
                                                                                                    </td>
                                                                                                    <td><?php echo $subject->sub_sem ?>
                                                                                                    </td>
                                                                                                    <td><?php echo $subject->is_lab ?>
                                                                                                    </td>
                                                                                                    <td
                                                                                                                        class="text-center p-0">
                                                                                                                        <a
                                                                                                                                            href="<?php echo base_url(); ?>Hod/delete_subject/<?php echo $subject->sub_num; ?>"><button 
