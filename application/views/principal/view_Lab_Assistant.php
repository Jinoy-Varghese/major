...
<tr>
    ...
    <td><input disabled value="<?php echo $lab_assistant_data->name ?>" id="cur_name" style="border:0;background:none;color:black;"></td>
    ...
    {
      echo"<td><amp-img alt='image' src='".base_url($lab_assistant_data->u_image)."' class='img-fluid img-thumbnail' layout='responsive' height='200px' width='200px'></amp-img></td>";
    }
    ?>
    </tr>
  </form>
