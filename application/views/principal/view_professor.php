...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">View Professor</li>
    </ol>
    </nav>
...
<tr>
    ...
    <td><?php echo date("d-m-yy",strtotime($professor_data->dob)) ?></td>
    <td>
    <?php 
          if($professor_data->gender=='m')
          {
            echo "Male";
          }
          elseif($professor_data->gender=='f')
          {
            echo "Female";
          }
    ?>
    ...
    <td><?php echo $professor_data->phone ?></td>
    <?php
    if($professor_data->u_image==null)
    {
    ...
    {
      echo"<td><amp-img alt='image' src='".base_url($professor_data->u_image)."' class='img-fluid img-thumbnail' layout='responsive' height='200px' width='200px'></amp-img></td>";
    }
    ?>
    </tr>
  </form>
