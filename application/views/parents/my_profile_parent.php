...
<div class="container">
    ...
    <div class="col-md-3 col-12 text-center pt-md-5 ml-md-n3">
      ...
      <div class="col-12 pt-md-5 ml-md-n4">
        ...
        <form method="post" action="<?php echo base_url("Parents/upload_image");?>" enctype="multipart/form-data">
...
<div class="col-md-12">
<form class="needs-validation mt-5" novalidate method="post" action="<?php echo base_url("Parents/update_profile");?>">
  <div class="form-row">
...
<div class="col-md-12">
<form class="needs-validation mt-5" novalidate action="<?php echo base_url("Parents/change_password");?>" method="post">
  <div class="form-row">
  <div class="col-md-4 mb-3">
