...
?>
    ...
    <form class="needs-validation mt-5" novalidate method="post"
        action="<?php echo base_url();?>home/insert_student_professor">
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control"
                    id="exampleInputEmail1" name="u_email" required>
                <div class="invalid-feedback">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="custom-select" id="validationCustom08" required name="course">
                    ...
                    {
                    echo "<option value='$subject_data->course'>$subject_data->course</option>";
                    }
                    ?>
                </select>
                <div class="valid-feedback">
