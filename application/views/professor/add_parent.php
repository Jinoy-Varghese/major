...
?>
    ...
    <form class="needs-validation mt-5" novalidate method="post" action="<?php echo base_url();?>home/insert_parent">
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
        <label for="validationCustom05">Guardian of</label>
        <input type="email" class="form-control" id="validationCustom05" name="s_mail" required>
        <div class="invalid-feedback">
