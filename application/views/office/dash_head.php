...
if(!isset($_SESSION['u_id']) OR $_SESSION['role']!="office")
{
...
?>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top mt-0 mb-0 pb-0 pt-0"><!-- sticky top can be replaced with fixed-botto or fixed-top -->
    ...
    <a href="#" class="navbar-brand mx-auto"><img src="<?php echo base_url('assets/image/logo1.png');?>"class="ml-n1 mt-n1" style='width:60px; height:60px;'></div></a>
      ...
      <ul class="navbar-nav my-2 my-lg-0">
        ...
        <li class="nav-item dropdown mr-4">
            ...
            <span class="dropdown-menu-arrow" ></span>
              <a class="dropdown-item" href="<?php echo site_url(); ?>Office/office_profile"><i class="fa fa-user mr-1"></i>My Profile</a>
